 ...
 * Desc: 
 * User: zhiqiang
 * Date: 2021-12-11 02:25
 */

namespace whereof\ThinkImage;

use Exception;
use whereof\ThinkImage\Driver\Gd;
use whereof\ThinkImage\Driver\GIF;
use whereof\ThinkImage\Driver\Imagick;

/**
 * Class Image
 * @author zhiqiang
 * @package whereof\think\image
 */
class Image
{
    /* 驱动相关常量定义 */
    ...
    public function __construct($type = self::IMAGE_GD, $imgname = null)
    {
        ...
        $class     = "whereof\\ThinkImage\\Driver\\{$class}";
